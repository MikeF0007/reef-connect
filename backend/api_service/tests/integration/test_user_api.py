...
class TestUserAPI:
    ...
    async def test_get_user_profile(self, client, test_user_profile):
    ...
    async def test_update_user_profile(self, client, test_user_profile):
    ...
    async def test_update_user_profile_partial(self, client, test_user_profile):
    ...
    async def test_get_user_settings(self, client, test_user_settings):
    ...
    async def test_get_user_settings_not_found(self, client):
    ...
    async def test_update_user_settings(self, client, test_user_settings):
    ...
    async def test_get_privacy_settings(self, client, test_privacy_settings):
    ...
    async def test_get_privacy_settings_not_found(self, client):
    ...
    async def test_update_privacy_settings(self, client, test_privacy_settings):
    ...
    async def test_get_other_user_profile(self, client, async_session):
    ...
    async def test_get_nonexistent_user_profile(self, client):
    ...
    async def test_invalid_update_data(self, client, test_user_profile):
